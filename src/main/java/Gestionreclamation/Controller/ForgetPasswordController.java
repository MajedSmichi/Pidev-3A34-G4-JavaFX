...
public class ForgetPasswordController {
    ...
    private void navigateToCodeVerificationView() {
        try {
            FXMLLoader codeVerificationViewLoader = new FXMLLoader(getClass().getResource("/Gestionreclamation/forgetPassword/codeConfirm.fxml"));
...
//            stage1.show();
    ...
    private void switchToChangePasswordView() {
        try {
            ...
            Parent changePasswordView = FXMLLoader.load(getClass().getResource("/Gestionreclamation/forgetPassword/changePassword.fxml")); // Ensure the path is correct
