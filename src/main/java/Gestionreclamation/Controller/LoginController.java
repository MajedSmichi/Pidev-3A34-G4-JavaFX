...
private void showVerificationCodeAlert() {
    ...
    private void navigateToUserList(String userEmail) {
        try {
            // Load the FXML file
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/Gestionreclamation/Dash.fxml"));
    ...
    private void navigateToFrontView() {
        try {
            Parent frontView = FXMLLoader.load(getClass().getResource("/Gestionreclamation/client.fxml"));
    ...
    private void navigateToRegistration() {
        try {
            Parent registrationView = FXMLLoader.load(getClass().getResource("/Gestionreclamation/Register/register.fxml")); // Assuming correct path
    ...
    private void navigateToFogetPassword() {
        try {
            Parent forgetPasswordView = FXMLLoader.load(getClass().getResource("/Gestionreclamation/forgetPassword/sendEmail.fxml"));
